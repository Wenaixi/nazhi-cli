...
// TestNew_PreParsesBaseURL 验证 Client.baseURLParsed 在 New() 阶段
...
// TestSyncCookieToken_LazyParseFallback 验证兼容性：直接构造 Client
...
// TestSyncCookieToken_ErrorPrefixUnified 验证 cleanup-cookie 修复：
